package com.babestudios.breeds.design
...
val BreedsLightColorScheme = lightColorScheme(
...
private val BreedsDarkColorScheme = darkColorScheme(
...
fun BreedsTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> BreedsDarkColorScheme
		else -> BreedsLightColorScheme
	}
...
val Dimens: Dimensions
	@Composable
	get() = BreedsTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = BreedsTheme.colorScheme
